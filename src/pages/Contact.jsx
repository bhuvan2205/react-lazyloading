const Contact = () => {
  return (
    <section className="px-6 dark:bg-gray-100 dark:text-gray-900 my-40">
	<div className="grid max-w-6xl grid-cols-1 p-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
